...
namespace Avioane
{
    //.DarkTurquoise, Color.DeepSkyBlue, Color.DodgerBlue
    //.DeepSkyBlue
    //.DodgerBlue
    ...
    public partial class Form1 : Form
    {
        ...
        int click = 0, poz = 0;
        int moves = 1, turn = 0; // 0 pt jucator si 1 pt calculator
        int score = 0; // 0=joc in derulare, 1=Jucatorul a castigat, 2=Calculatorul a castigat
        ...
        Color[] c = { Color.DarkTurquoise, Color.DeepSkyBlue, Color.DodgerBlue };
        ...
        //Genereaza Tabla Jucatorului, Tabla Calculatorului, Avioanele si Butoanele
        public void GenerareObiecte()
        {
            ...
            //Mesajul de sus a ferestrei
            message.Top = 10;
            message.Left = 10;
            message.Text = "Plasati 3 Avioane. Rotiti avionul și apasati pe casuța în care doriti sa-l plasati.";
            ...
            for (i = 0; i < 10; i++)
            {
                ...
                for (j = 0; j < 10; j++)
                {
                    ...
                    RoboTable[i][j].BackColor = Color.LightGray;
                    RoboTable[i][j].BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
                    this.Controls.Add(RoboTable[i][j]);
                    RoboTable[i][j].Tag = i.ToString() + "/" + j.ToString(); //  i = linia, j = coloana matricei
            ...
            for (i = 0; i < 4; i++)
            {
                ...
                for (j = 0; j < 4; j++)
                {
                    ...
                    if (p[0, i, j] == 1)
                    {
                        Plane[i][j].BackColor = Color.Navy;
        ...
        //Creeaza 3 avioane in mod random pentru Calculator !
        ...
        //Plaseaza 3 avioane pe Tabla Jucatorului !
        ...
        public void RoboTurn()
        {
            ...
            while (fincell == 0)
            {
                ...
                if (PlayerTable[x][y].TabIndex < 4)
                {
                    ...
                    { //Deseneaza intreg avionul cand a fost lovit
        ...
        //Click cand RandulCalculatorului=RandulJucatorului
        ...
        private void NextTurn()
        {
            ...
            else
            {
                ...
                {
                    if (RoboPlaneNo == 0)
                        title.Text = "Felicitari, Ai castigat!";
                    else
                        title.Text = "Calculatorul a castigat!";
        ...
        //Reseteaza ecranul dupa finalul jocului cu desemnarea castigatorului, new game button si exit button
...
//Exit Button
        ...
        public void InitFormSettings() 
        {
            ...
            this.Text = "JOCUL AVIOANE";
            this.BackgroundImage = Image.FromFile("funnyplane.png");
            this.BackgroundImageLayout = ImageLayout.Stretch;


            //Mesaje 
            title.Text= "Lucrare de atestat - Tablouri Bidimensionale - Jocul Avioane";
            ...
            collegename.Font = new System.Drawing.Font("Lucida Calligraphy", 18F, (System.Drawing.FontStyle.Bold));
            ...
            myname.Font = new System.Drawing.Font("Lucida Calligraphy", 12.5F, (System.Drawing.FontStyle.Bold));
            ...
            teachname.Font = new System.Drawing.Font("Lucida Calligraphy", 12.5F, (System.Drawing.FontStyle.Bold));
